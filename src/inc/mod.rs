//! Gestiona las incidencias producidas en los marcajes.
//!
...
//! - Corrección de la hora de salida: Teniendo en cuenta,
...
//!   la eliminación de marcajes realizados por él.
//!
//! Flujo de las incidencias:
//!  - El empleado, registrador o supervisor realiza una
//!    solicitud indicando el tipo de incidencia. Si el
//!    usuario es registrador puede eliminar marcajes
//!    que creo el. El supervisor puede actuar en nombre
...
//!    solicitudes o las rechazan motivando. Cuando se acepta
...
//!    quedará en estado inconsistente y el usuario podrá modificarlo,
